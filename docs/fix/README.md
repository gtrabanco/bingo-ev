...
|--------|-------|--------|------------|-------|
| `48-newsletter-processor` | Name gtrabanco.com newsletter service as processor in privacidad | `in-progress` | fix/46 ✓ | [#48](https://github.com/gtrabanco/bingo-ev/issues/48) |
