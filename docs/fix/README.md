...
| `71-org-logo-png` | Swap Organization.logo from SVG to PNG for reliable Google Rich Results acceptance | `pending` | fix/72 ✓ | [#71](https://github.com/gtrabanco/bingo-ev/issues/71) |
...
| `69-og-brand-meta` | Add og:site_name + Organization logo (JSON-LD) for brand in previews & search | `in-review` | — | [#69](https://github.com/gtrabanco/bingo-ev/issues/69) |
