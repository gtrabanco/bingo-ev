...
| 11 | `hall-of-fame` | in-progress | — | **XS.** Rename `/galeria` → `/hall-of-fame` (301 redirect for SEO continuity) and add a "Hall of Fame" nav link below the header in `index.astro`. All internal `/galeria` links updated. |
